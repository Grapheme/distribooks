				...
				<div class="basket-min">
					...
					?>
						<div>
							...
							<p class="basket-item-name all" style="width: 210px;; color: #000; margin-left: 15px; float:right;"><?=lang('basket_page_part4');?> &mdash; <span id="count-book"><?=count($basket_list).' '.$this->plural_words->pluralBook(count($basket_list));?></span> <?=lang('basket_page_part5');?></p>
